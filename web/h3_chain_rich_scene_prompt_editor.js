...
import {
    ...
    promptValueToText,
    sharedPrompt,
} from "./h3_chain_plan_core.mjs?v=0.4.10";
import {
    buildPromptAssistantContext,
    makePromptAssistRequest,
} from "./h3_prompt_assistant_core.mjs?v=0.4.10";
import {PromptAssistantClient} from "./h3_prompt_assistant_client.mjs?v=0.4.10";
import {
    directOptimizerConfigurationError,
    makeDirectPromptOptimizeRequest,
} from "./h3_prompt_optimizer_core.mjs?v=0.4.10";
import {
...
} from "./h3_prompt_history_core.mjs?v=0.4.10";
import {availableReferenceRecords} from "./h3_reference_preview_core.mjs?v=0.4.10";
import {
    RICH_PROMPT_GUIDES,
    normalizeRichGuide,
    optimizerSource,
    ...
    tokenizeRichPrompt,
} from "./h3_rich_prompt_editor_core.mjs?v=0.4.10";
import * as promptCompanionSync from "./h3_prompt_companion_sync.mjs?v=0.4.10";
