...
| ✨ | Optional timeline Plan Studio and rich prompt-only editor |
...
2. Edit scene prompts in the Plan, Scene Prompt Editor, experimental Rich
   Scene Prompt Editor, or optional timeline Plan Studio.
...
- [Scene authoring](docs/SCENE_AUTHORING.md) — Plan, standard/rich Prompt
  Editors, Plan Studio, revisions, seeds, and bounded ranges.
