...
assert.ok(directives.length >= 6);
assert.ok(directives.slice(0, 6).every(
    (item) => item.label.startsWith("[reference generation")));
...
const section = promptCompletionItems(sectionQuery, records, {referenceMode:"tagged"})[0];
