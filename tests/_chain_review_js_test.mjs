...
assert.match(reviewSource, /updateLivePlanPrompt/);
assert.match(reviewSource, /_h3PromptCompanionSetScenePrompt/);
assert.match(reviewSource, /promptSyncTimer/);
...
assert.match(reviewSource, /mountReviewControls/);
assert.match(reviewSource, /node\._h3ReviewMounted = false/);
