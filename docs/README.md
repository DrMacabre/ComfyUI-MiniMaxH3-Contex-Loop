...
| Guide | Use it for |
|---|---|
| [Scene authoring](SCENE_AUTHORING.md) | Plan JSON, standard/rich prompt editors, Plan Studio, prompt history, seeds, timing, and scene ranges |
| [Scheduled references](SCHEDULED_REFERENCES.md) | Per-scene image/video/audio references, aliases, compliance, preview, and conversion |
